...
var vehicles = __webpack_require__(13);

$(function () {
  setAPIOrigin(location, config);
  events.addHandlers();
  vehicles.addHandlers();
});
...
var config = {
  apiOrigins: {
    ...
    production: 'https://tranquil-tundra-61203.herokuapp.com/'
  }
};
...
var onGetVehicles = function onGetVehicles(event) {
  event.preventDefault();
  console.log('onGetVehicles ran');
  // const data = getFormFields(event.target)
  api.getVehicles().then(ui.onGetVehiclesSuccess).catch(ui.onGetVehiclesFailure);
};

var onGetUserVehicles = function onGetUserVehicles(event) {
  event.preventDefault();
  console.log('onGetUserVehicles ran');
  // const data = getFormFields(this)
  api.getUserVehicles().then(ui.onGetUserVehiclesSuccess).catch(ui.onGetUserVehiclesFailure);
};

var onCreateVehicle = function onCreateVehicle(event) {
  event.preventDefault();
  console.log('onCreateVehicle ran');
  // const data = getFormFields(event.target)
  api.createVehicle().then(ui.onCreateVehicleSuccess).catch(ui.onCreateVehicleFailure);
};

var onDeleteVehicle = function onDeleteVehicle(event) {
  event.preventDefault();
  console.log('onDeleteVehicle ran');
  api.deleteVehicle().then(ui.onDeleteVehicleSuccess).catch(ui.onDeleteVehicleFailure);
};

var onUpdateVehicle = function onUpdateVehicle(event) {
  event.preventDefault();
  console.log('onUpdateVehicle ran');
  // const data = getFormFields(event.target)
  api.updateVehicle().then(ui.onUpdateVehicleSuccess).catch(ui.onUpdateVehicleFailure);
};
...
var getVehicles = function getVehicles(data) {
  return $.ajax({
...
var getUserVehicles = function getUserVehicles(data) {
  return $.ajax({
...
var deleteVehicle = function deleteVehicle(data) {
  return $.ajax({
...
var onGetVehiclesSuccess = function onGetVehiclesSuccess(data) {
  console.log('getVehiclesSuccess ran');
  $('#getVehicles').text('get vehicles success');
  console.log(data);
};

var onGetVehiclesFailure = function onGetVehiclesFailure(error) {
  $('#').text('Error getting vehicles');
  console.error(error);
};

var onGetUserVehiclesSuccess = function onGetUserVehiclesSuccess(data) {
  app.user = data.user;
  $('#').text('get user vehicle success');
  console.log('get user vehicle ran. data is :', data);
};

var onGetUserVehiclesFailure = function onGetUserVehiclesFailure(error) {
  $('#').text('Error getting user vehicle');
  console.log('get user vehicle failure ran. error is :', error);
};

var onCreateVehicleSuccess = function onCreateVehicleSuccess(data) {
  $('#message').text('create vehicle success');
  console.log('create vehicle success ran. and nothing was returned');
};

var onCreateVehicleFailure = function onCreateVehicleFailure(error) {
...
var onDeleteVehicleFailure = function onDeleteVehicleFailure(error) {
  $('#message').text('Error on delete');
  console.log('delete failure ran. error is :', error);
};

var onUpdateVehicleSuccess = function onUpdateVehicleSuccess() {
  $('#message').text('update vehicle successful');
  console.log('update vehicle success ran. and nothing was returned');
};

var onUpdateVehicleFailure = function onUpdateVehicleFailure(error) {
  $('#message').text('Error on update');
  console.log('update vehicle failure ran. error is :', error);
};

module.exports = {
  onGetVehiclesSuccess: onGetVehiclesSuccess,
  onGetVehiclesFailure: onGetVehiclesFailure,
  onGetUserVehiclesSuccess: onGetUserVehiclesSuccess,
  onGetUserVehiclesFailure: onGetUserVehiclesFailure,
